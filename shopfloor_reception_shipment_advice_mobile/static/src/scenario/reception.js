...
const ReceptionShipmentAdvice = process_registry.extend("reception", {
    ...
    computed: {
        ...
        moves_to_select: function () {
            ...
            return reception_scenario.component.computed.moves_to_select.bind(this)();
        },
    },
    ...
    methods: {
        ...
        _get_reception_headers: function (shipment_id) {
            const res = {};
        ...
        _get_current_shipment: function () {
            if (
                ["select_document", "manual_selection"].includes(this.current_state_key)
            ) {
                return {};
            }
        ...
        dock_available_shipments: function () {
            return this.state.data.shipments;
        },
        manual_select_shipment_options: function () {
            return {
                group_title_default:
                    "Today's shipments on " + this.state.data.dock.name,
        ...
        _get_states: function () {
            ...
            states.select_document.display_info.scan_placeholder += " / dock";
        ...
        current_doc: function () {
            ...
            if (_.isEmpty(data.shipment)) {
                return reception_scenario.component.methods.current_doc.bind(this)();
            }
            return {
        ...
        select_move_from_record: function () {
            ...
            return reception_scenario.component.methods.select_move_from_record.bind(
                this
            )();
        },
        select_move_from_record_options: function () {
            const shipment = this.state.data.shipment;
            const options =
                reception_scenario.component.methods.select_move_from_record_options.bind(
                    this
                )();
            if (shipment) {
        ...
        select_move_from_record_key: function () {
            ...
            return reception_scenario.component.methods.select_move_from_record_key.bind(
                this
            )();
        },
    },
