...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo14-addon-shopfloor_checkout_putinpack_restriction',
        ...
        'odoo14-addon-shopfloor_full_location_reservation',
        ...
        'odoo14-addon-shopfloor_single_product_transfer_unique_order_at_location',
        'odoo14-addon-shopfloor_vendor_packaging',
        ...
        'odoo14-addon-stock_available_to_promise_release_shipment_advice',
        ...
        'odoo14-addon-stock_service_level',
        'odoo14-addon-stock_service_level_route',
