...
--- | --- | --- | ---
[stock_available_to_promise_release](stock_available_to_promise_release/) | 16.0.2.0.0 |  | Release Operations based on available to promise
...
[stock_release_channel](stock_release_channel/) | 16.0.2.0.0 | [![sebalix](https://github.com/sebalix.png?size=30px)](https://github.com/sebalix) | Manage workload in WMS with release channels
[stock_release_channel_auto_release](stock_release_channel_auto_release/) | 16.0.1.0.0 |  | Add an automatic release mode to the release channel
[stock_release_channel_batch_mode_commercial_partner](stock_release_channel_batch_mode_commercial_partner/) | 16.0.1.0.0 |  | Release pickings into channels by batch of same commercial entity
