...
[sale_stock_available_to_promise_release](sale_stock_available_to_promise_release/) | 13.0.1.4.1 | Integration between Sales and Available to Promise Release
[shopfloor](shopfloor/) | 13.0.3.0.0 | manage warehouse operations with barcode scanners
...
[shopfloor_mobile](shopfloor_mobile/) | 13.0.1.10.0 | Mobile frontend for WMS Shopfloor app
...
[shopfloor_workstation](shopfloor_workstation/) | 13.0.1.0.0 | Manage warehouse workstation with barcode scanners
[stock_available_to_promise_release](stock_available_to_promise_release/) | 13.0.1.10.6 | Release Operations based on available to promise
...
[stock_move_source_relocate_dynamic_routing](stock_move_source_relocate_dynamic_routing/) | 13.0.1.0.0 | Glue module
...
[stock_reception_screen](stock_reception_screen/) | 13.0.1.4.0 | Dedicated screen to receive/scan goods.
