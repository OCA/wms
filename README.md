...
[stock_release_channel](stock_release_channel/) | 16.0.2.6.0 | [![sebalix](https://github.com/sebalix.png?size=30px)](https://github.com/sebalix) | Manage workload in WMS with release channels
