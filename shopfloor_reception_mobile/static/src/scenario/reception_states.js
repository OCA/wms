...
export const reception_states = function () {
    return {
        ...
        select_document: {
            display_info: {
                title: this.$t("Choose an operation"),
                scan_placeholder: this.$t("Scan document / product / package"),
            },
            events: {
                select: "on_select",
            },
        ...
        select_move: {
            display_info: {
                title: this.$t("Select a move"),
                scan_placeholder: this.$t("Scan product / package"),
            },
            events: {
        ...
        set_lot: {
            display_info: {
                title: this.$t("Set lot"),
                scan_placeholder: this.$t("Scan lot"),
                scan_input_placeholder_expiry: this.$t("Scan expiration date"),
            },
            on_scan: (barcode) => {
                this.wait_call(
        ...
        set_destination: {
            display_info: {
                title: this.$t("Set destination"),
                scan_placeholder: this.$t("Scan destination location"),
            },
            on_scan: (location) => {
                this.wait_call(
        ...
        select_dest_package: {
            display_info: {
                title: this.$t("Select destination package"),
                scan_placeholder: this.$t("Scan destination package"),
            },
            events: {
                select: "on_select",
            },
        ...
        confirm_new_package: {
            display_info: {
                title: this.$t("Confirm new package"),
            },
            events: {
                confirm: "on_confirm",
                go_back: "on_back",
        ...
        confirm_over_reception: {
            display_info: {
                title: this.$t("Confirm over reception"),
                message: this.$t(
                    "You are about to receive more than expected. Are you sure?"
                ),
            },
            events: {
                confirm: "on_confirm",
