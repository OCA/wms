...
(t = this),
    (e = function () {
            ...
            render: function (t, e) {
                ...
                if (((c.routerViewDepth = h), l)) {
                    var v = f[s],
                        y = v && v.component;
                    return y
                        ? (v.configProps && o(y, c, v.route, v.configProps), u(y, c, i))
                        : u();
                }
                var m = p.matched[h],
                    g = m && m.components[s];
                ...
                return (
                    b && (r(f[s], {route: p, configProps: b}), o(g, c, p, b)),
                    u(g, c, i)
                );
            },
        };
        ...
        function b(t, e) {
            ...
            return (
                ...
                r.every(function (r) {
                    var n = t[r],
                        o = e[r];
                    return typeof n === "object" && typeof o === "object"
                        ? b(n, o)
                        : String(n) === String(o);
                })
            );
        ...
        function $(t) {
            ...
            return function (r, n) {
                for (
                    var o = "",
                        i = r || {},
                        a = (n || {}).pretty ? S : encodeURIComponent,
                        c = 0;
                    c < t.length;
                    c++
                ) {
        ...
        function B(t, e, n, o) {
            ...
            if (i.name) {
                var a = (i = r({}, t)).params;
                return a && typeof a === "object" && (i.params = r({}, a)), i;
            }
            ...
            var s = (function (t) {
                ...
                f = (e && e.path) || "/",
                h = s.path ? w(s.path, f, n || i.append) : f,
                l = (function (t, e, r) {
                    void 0 === e && (e = {});
                    var n,
                        o = r || p;
            ...
            N = {
                ...
                render: function (t) {
                    var e = this,
                        ...
                        d = p == null ? "router-link-active" : p,
                        v = f == null ? "router-link-exact-active" : f,
                        y = this.activeClass == null ? d : this.activeClass,
                        m = this.exactActiveClass == null ? v : this.exactActiveClass,
                        b = c.redirectedFrom
                            ? l(null, B(c.redirectedFrom), null, n)
                            : c;
                    (s[m] = g(o, b)),
                        (s[y] = this.exact
                            ? s[m]
                    ...
                    if (R) {
                        ...
                        if (R.length > 1 || !R.length)
                            return R.length === 0 ? t() : t("span", {}, R);
                    }
                    if (this.tag === "a") (k.on = x), (k.attrs = {href: u});
                    else {
                        var E = (function t(e) {
                            if (e)
                                for (var r, n = 0; n < e.length; n++) {
                                    if ((r = e[n]).tag === "a") return r;
                        ...
                        if (E) {
                            ...
                            for (var j in x)
                                j in O.on ? O.on[j].push(x[j]) : (O.on[j] = w);
            ...
            t.forEach(function (t) {
                !(function t(e, r, n, o, i, a) {
                    ...
                    if (
                        ...
                        for (
                            var h = Array.isArray(o.alias) ? o.alias : [o.alias], l = 0;
                            l < h.length;
                            ++l
                        ) {
                            var d = h[l],
        ...
        function Y(t, e) {
            ...
            function a(t, r, a) {
                ...
                if (s) {
                    ...
                    if (
                        (typeof c.params !== "object" && (c.params = {}),
                        r && typeof r.params === "object")
                    )
                        for (var h in r.params)
                            !(h in c.params) &&
                                f.indexOf(h) > -1 &&
                                (c.params[h] = r.params[h]);
            ...
            function c(t, r) {
                var n = t.redirect,
                    o = typeof n === "function" ? n(l(t, r, null, e)) : n;
                if (
                ...
                return (
                    ...
                    s
                        ? (i[s],
                          a(
                              {_normalized: !0, name: s, query: f, hash: h, params: d},
                              void 0,
                              r
                          ))
                        : p
        ...
        function W(t, e, r) {
            ...
            for (var o = 1, i = n.length; o < i; ++o) {
                var a = t.keys[o - 1],
                    c = typeof n[o] === "string" ? decodeURIComponent(n[o]) : n[o];
        ...
        function ft(t, e) {
            ...
            if (n && typeof t.selector === "string") {
                ...
                if (o) {
                    ...
                    })(o, (i = {x: st((r = i).x) ? r.x : 0, y: st(r.y) ? r.y : 0}));
                } else ct(t) && (e = ut(t));
            } else n && ct(t) && (e = ut(t));
        ...
        var ht,
            lt =
                J &&
                (((ht = window.navigator.userAgent).indexOf("Android 2.") === -1 &&
                    ht.indexOf("Android 4.0") === -1) ||
                    ht.indexOf("Mobile Safari") === -1 ||
                    ht.indexOf("Chrome") !== -1 ||
                    ht.indexOf("Windows Phone") !== -1) &&
                window.history &&
        ...
        function mt(e) {
            return function (r, n, o) {
                ...
                gt(e, function (e, r, n, u) {
                    if (typeof e === "function" && void 0 === e.cid) {
                        (i = !0), a++;
                        var s,
                            p = xt(function (t) {
                                var r;
                                ((r = t).__esModule ||
                                    (wt && r[Symbol.toStringTag] === "Module")) &&
                                    (t = t.default),
                                    (e.resolved =
                                        typeof t === "function" ? t : H.extend(t)),
                                    (n.components[u] = t),
                                    --a <= 0 && o();
                            }),
                            f = xt(function (e) {
                                var r =
                                    "Failed to resolve async component " + u + ": " + e;
                        ...
                        if (s)
                            if (typeof s.then === "function") s.then(p, f);
                            else {
                                var h = s.component;
        ...
        var wt = typeof Symbol === "function" && typeof Symbol.toStringTag === "symbol";
        function xt(t) {
            var e = !1;
            return function () {
        ...
        function Et(t, e, r, n) {
            var o = gt(t, function (t, n, o, i) {
                var a = (function (t, e) {
                    return typeof t !== "function" && (t = H.extend(t)), t.options[e];
                })(t, e);
                if (a)
        ...
        (Rt.prototype.listen = function (t) {
            ...
            (Rt.prototype.confirmTransition = function (r, n, o) {
                ...
                if (g(r, a) && r.matched.length === a.matched.length)
                    return this.ensureURL(), c(new kt(r));
                var u = (function (t, e) {
                        var r,
        ...
        var Lt = (function (t) {
            ...
            qt = function (t) {
                ...
                var e = t.mode || "hash";
                switch (
                    ((this.fallback = e === "history" && !lt && !1 !== t.fallback),
        ...
        return (
            ...
            (qt.prototype.push = function (t, e, r) {
                var n = this;
                if (!e && !r && typeof Promise !== "undefined")
