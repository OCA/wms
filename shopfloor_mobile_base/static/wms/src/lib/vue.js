...
(function (global, factory) {
    ...
    var inWeex = typeof WXEnvironment !== "undefined" && Boolean(WXEnvironment.platform);
    ...
    function normalizeScopedSlots(slots, normalSlots, prevSlots) {
        ...
        var isStable = slots ? Boolean(slots.$stable) : !hasNormalSlots;
    ...
    function updateChildComponent(
        ...
        var hasDynamicScopedSlot = Boolean((newScopedSlots && !newScopedSlots.$stable) ||
        ...
        var needsForceUpdate = Boolean(renderChildren || // Has new static slots
    ...
    function parseHTML(html, options) {
        ...
        function handleStartTag(match) {
            ...
            var unary = isUnaryTag$$1(tagName) || Boolean(unarySlash);
    ...
    function parse(template, options) {
        ...
        maybeComponent = function (el) {
            return Boolean(el.component) || !isReservedTag(el.tag);
        };
    ...
    function processSlotContent(el) {
        ...
        if (slotTarget) {
            ...
            el.slotTargetDynamic = Boolean(el.attrsMap[":slot"] || el.attrsMap["v-bind:slot"]);
    ...
    function genDirectives(el, state) {
        ...
        for (i = 0, l = dirs.length; i < l; i++) {
            ...
            if (gen) {
                ...
                needRuntime = Boolean(gen(el, dir, state.warn));
            }
            if (needRuntime) {
                hasRuntime = true;
                res +=
        ...
        if (children.length) {
            ...
            if (
                ...
                var normalizationType = checkSkip
                    ...
                    : "";
                return (
                    String((altGenElement || genElement)(el$1, state)) + normalizationType
                );
            }
