...
(function (global, factory) {
    ...
    var inWeex =
        typeof WXEnvironment !== "undefined" && Boolean(WXEnvironment.platform);
    ...
    function updateChildComponent(
        ...
        var hasDynamicScopedSlot = Boolean(
        ...
        if (children.length) {
            ...
            if (
                ...
                var normalizationType = checkSkip
                    ...
                    : "";
                return (
                    String((altGenElement || genElement)(el$1, state)) +
                    normalizationType
                );
            }
