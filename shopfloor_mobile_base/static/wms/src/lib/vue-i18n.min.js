...
(t = this),
    (e = function () {
        ...
        function _(t) {
            for (var e = arguments, n = Object(t), a = 1; a < arguments.length; a++) {
                ...
                if (i != null) {
                    var o = void 0;
                    for (o in i)
                        m(i, o) && (r(i[o]) ? (n[o] = _(n[o], i[o])) : (n[o] = i[o]));
                }
            }
            return n;
        }
                ...
                beforeCreate: function () {
                    ...
                    if (((t.i18n = t.i18n || (t.__i18n ? {} : null)), t.i18n)) {
                        if (t.i18n instanceof nt) {
                            ...
                            a && s(a) && (t.i18n.messages = _(t.i18n.messages, a)),
            ...
            w = {
                ...
                render: function (e, n) {
                    ...
                    a(i.format)
                        ? (c = i.format)
                        : r(i.format) &&
                          (i.format.key && (c = i.format.key),
                          (u = Object.keys(i.format).reduce(function (e, n) {
                              var r;
                              return h(t, n)
                                  ? Object.assign(
                                        {},
        ...
        function M(t, e, n, r) {
            if (T(t, n)) {
                ...
                ((function (t, e) {
                    ...
                    g(e.value, e.oldValue) &&
                    g(t._localeMessage, a.getLocaleMessage(a.locale))) ||
                    L(t, e, n);
            }
        }
        function C(t, n, r, a) {
        ...
        function T(t, n) {
            ...
            return r
                ? Boolean(r.$i18n) ||
                      (e("VueI18n instance does not exists in Vue instance"), !1)
                : (e("Vue instance does not exists in VNode context"), !1);
        }
        function L(t, n, r) {
            var i,
                o,
            ...
            if (c || u || f)
                if (c) {
                    ...
                    (t._vt = t.textContent =
                        h != null
                            ? (i = p.$i18n).tc.apply(i, [c, h].concat(I(u, f)))
                            : (o = p.$i18n).t.apply(o, [c].concat(I(u, f)))),
            ...
            !(function (t) {
                t.prototype.hasOwnProperty("$i18n") ||
                    ...
                    (t.prototype.$tc = function (t, e) {
                        ...
                        return a._tc.apply(
                            a,
                            [t, a.locale, a._getMessages(), this, e].concat(n)
                        );
                    }),
                ...
                k.mixin(v),
                k.directive("t", {bind: $, update: M, unbind: C}),
                k.component(b.name, b),
                k.component(w.name, w),
        ...
        var O = /^(?:\d)+/,
            ...
            z = 8,
            B = [];
        (B[H] = {ws: [H], ident: [3, j], "[": [P], eof: [A]}),
            (B[1] = {ws: [1], ".": [2], "[": [P], eof: [A]}),
            (B[2] = {ws: [2], ident: [3, j], 0: [3, j], number: [3, j]}),
            (B[3] = {
                ident: [3, j],
                0: [3, j],
                number: [3, j],
            ...
            (B[V] = {"'": [P, j], eof: z, else: [V, j]}),
            (B[E] = {'"': [P, j], eof: z, else: [E, j]});
        ...
        function q(t) {
            var e,
                ...
                a = t.trim();
            return (
                (t.charAt(0) !== "0" || !isNaN(t)) &&
                ((r = a),
                U.test(r)
                    ? (n = (e = a).charCodeAt(0)) !== e.charCodeAt(e.length - 1) ||
                      (n !== 34 && n !== 39)
                        ? e
                        : e.slice(1, -1)
                    : "*" + a)
        ...
        var X,
            ...
            tt = {
                ...
                capitalize: function (t) {
                    return String(t.charAt(0).toLocaleUpperCase()) + t.substr(1);
                },
            },
            et = new x(),
            nt = function (t) {
                var e = this;
                void 0 === t && (t = {}),
                    !k && typeof window !== "undefined" && window.Vue && D(window.Vue);
                ...
                (this._vm = null),
                    ...
                    (this._sync = void 0 === t.sync || Boolean(t.sync)),
                    (this._fallbackRoot =
                        void 0 === t.fallbackRoot || Boolean(t.fallbackRoot)),
                    (this._formatFallbackMessages =
                        void 0 !== t.formatFallbackMessages &&
                        Boolean(t.formatFallbackMessages)),
                    (this._silentTranslationWarn =
                        void 0 !== t.silentTranslationWarn && t.silentTranslationWarn),
                    (this._silentFallbackWarn =
                        void 0 !== t.silentFallbackWarn && Boolean(t.silentFallbackWarn)),
                    ...
                    (this._preserveDirectiveContent =
                        ...
                        Boolean(t.preserveDirectiveContent)),
                    ...
                    (this._exist = function (t, n) {
                        return (
                            !(!t || !n) && (!l(e._path.getPathValue(t, n)) || Boolean(t[n]))
                        );
                    }),
        ...
        return (
            (nt.prototype._checkLocaleMessage = function (t, r, i) {
            ...
            (nt.prototype._interpolate = function (t, e, r, i, o, u, f) {
                if (!e) return null;
                var h,
                    p = this._path.getPathValue(e, r);
                if (n(p) || s(p)) return p;
                if (l(p)) {
                    if (!s(e)) return null;
                    if (!a((h = e[r])) && !c(h)) return null;
                } else {
                ...
                return (
                    a(h) &&
                        ...
                        (h = this._link(t, e, h, i, "raw", u, f)),
                    this._render(h, o, u, r)
                );
            }),
            (nt.prototype._link = function (t, e, r, a, i, o, s) {
                ...
                for (var u in c)
                    if (c.hasOwnProperty(u)) {
                        ...
                        (v = this._warnDefault(t, g, v, a, n(o) ? o : [o], i)),
                            this._modifiers.hasOwnProperty(_)
                                ? (v = this._modifiers[_](v))
                                : tt.hasOwnProperty(_) && (v = tt[_](v)),
                            s.pop(),
                            (l = v ? l.replace(f, v) : l);
                    }
                return l;
            ...
            (nt.prototype._render = function (t, e, n, r) {
                ...
                return (
                    i || (i = et.interpolate(t, n, r)),
                    e !== "string" || a(i) ? i : i.join("")
                );
            }),
            ...
            (nt.prototype._appendBlockToChain = function (t, e, n) {
                for (var r = !0, i = 0; i < e.length && typeof r === "boolean"; i++) {
                    var o = e[i];
            ...
            (nt.prototype._getLocaleChain = function (t, e) {
                ...
                if (!i) {
                    ...
                    (s = a((o = n(e) ? e : r(e) ? (e.default ? e.default : null) : e))
                        ? [o]
                        : o) && this._appendBlockToChain(i, s, null),
            ...
            (nt.prototype._translate = function (t, e, n, r, a, i, o) {
                for (var s, c = this._getLocaleChain(e, n), u = 0; u < c.length; u++) {
                    var f = c[u];
                    if (!l((s = this._interpolate(f, t[f], r, a, i, o, [r])))) return s;
                }
                return null;
            }),
            (nt.prototype._t = function (t, e, n, r) {
                ...
                return (
                    (c = this._warnDefault(l, t, c, r, i, "string")),
            ...
            (nt.prototype._tc = function (t, e, n, r, a) {
                ...
                return (
                    ...
                    (o = c.locale === null ? [c.params] : [c.locale, c.params]),
            ...
            (nt.prototype._localizeDateTime = function (t, e, n, r, a) {
                for (
                    var i = e, o = r[i], s = this._getLocaleChain(e, n), c = 0;
                    c < s.length;
                    c++
                ) {
                    var u = s[c];
            ...
            (nt.prototype._getNumberFormatter = function (t, e, n, r, a, i) {
                for (
                    var o = e, s = r[o], c = this._getLocaleChain(e, n), u = 0;
                    u < c.length;
                    u++
                ) {
                    var f = c[u];
                    if (((o = f), !l((s = r[f])) && !l(s[a]))) break;
                }
                ...
                if (i) h = new Intl.NumberFormat(o, Object.assign({}, p, i));
                    ...
                    var m = o + "__" + a;
                    (h = this._numberFormatters[m]) ||
                        (h = this._numberFormatters[m] = new Intl.NumberFormat(o, p));
                }
                return h;
            }),
                ...
                return (
                    n.length === 1
                        ? a(n[0])
                            ? (s = n[0])
                            : r(n[0]) &&
                              (n[0].locale && (o = n[0].locale),
                              n[0].key && (s = n[0].key),
                              (l = Object.keys(n[0]).reduce(function (e, r) {
                                  var a;
                                  return h(t, r)
                                      ? Object.assign(
                                            {},
