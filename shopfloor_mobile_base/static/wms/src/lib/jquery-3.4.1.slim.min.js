...
!(function (e, t) {
    ...
    typeof module === "object" && typeof module.exports === "object"
        ...
        : t(e);
})(typeof window !== "undefined" ? window : this, function (g, e) {
    "use strict";
    var t = [],
        v = g.document,
    ...
    (E.fn = E.prototype =
        ...
        E.extend({
            ...
            trim: function (e) {
                return e == null ? "" : (String(e)).replace(d, "");
            },
            ...
            merge: function (e, t) {
                for (var n = Number(t.length), r = 0, i = e.length; r < n; r++) e[i++] = t[r];
                return (e.length = i), e;
            },
            grep: function (e, t, n) {
        ...
        typeof Symbol === "function" && (E.fn[Symbol.iterator] = t[Symbol.iterator]),
        E.each(
    ...
    var h = (function (n) {
        ...
        function se(t, e, n, r) {
            ...
            if (
                ((n = n || []),
                typeof t !== "string" || !t || (d !== 1 && d !== 9 && d !== 11))
            )
                return n;
                ...
                function (e, t, n, r) {
                    ...
                    if (((n = n || []), c.length === 1)) {
                        if (
                            ...
                            if (
                                !(t = (x.find.ID(a.matches[0].replace(te, ne), t) ||
                                    [])[0])
                            )
                                return n;
                            l && (t = t.parentNode),
    ...
    (E.filter = function (e, t, n) {
        ...
        E.fn.extend({
            ...
            is: function (e) {
                return Boolean(L(this, typeof e === "string" && k.test(e) ? E(e) : e || [], !1)
                    .length);
            },
        });
    var j,
        ...
        E.each(
            {
                ...
                contents: function (e) {
                    return typeof e.contentDocument !== "undefined"
                        ? e.contentDocument
            ...
            function (r, i) {
                E.fn[r] = function (e, t) {
                    ...
                    return (
                        r.slice(-5) !== "Until" && (t = e),
                        t && typeof t === "string" && (n = E.filter(t, n)),
                        this.length > 1 &&
        ...
        E.extend({
            ...
            when: function (e) {
                ...
                if (
                    ...
                    o.state() === "pending" || x(i[t] && i[t].then))
                )
                    return o.then();
    ...
    var z = function (e, t, n, r, i, o, a) {
            var s = 0,
                u = e.length,
                l = n == null;
            if (T(n) === "object") for (s in ((i = !0), n)) z(e, t, s, n[s], !0, o, a);
            else if (
                void 0 !== r &&
                ((i = !0),
                x(r) || (a = !0),
        ...
        E.fn.extend({
            data: function (n, e) {
                ...
                if (void 0 === n) {
                    if (
                        this.length &&
                        ((i = K.get(o)), o.nodeType === 1 && !G.get(o, "hasDataAttrs"))
                    ) {
                        t = a.length;
                        while (t--)
                            a[t] &&
    ...
    var se = function (e, t) {
            return (
                ...
                (e.style.display === "" && oe(e) && E.css(e, "display") === "none")
            );
        },
        ue = function (e, t, n, r) {
            var i,
                      ...
                      r.style.display === "" &&
                          ...
                          (l[c] =
                              ...
                              (u = le[s]) ||
                                  ...
                                  u === "none" && (u = "block"),
                                  (le[s] = u)))))
                    : n !== "none" && ((l[c] = "none"), G.set(r, "display", n)));
    ...
    function xe(e, t, n, r, i) {
        for (
            ...
            if ((o = e[p]) || o === 0)
                if (T(o) === "object") E.merge(d, o.nodeType ? [o] : o);
                else if (be.test(o)) {
    ...
    (ye = v.createDocumentFragment().appendChild(v.createElement("div"))),
        ...
        (b.noCloneChecked = Boolean(ye.cloneNode(!0).lastChild.defaultValue));
    var we = /^key/,
        ...
        special: {
            ...
            click: {
                ...
                trigger: function (e) {
                    var t = this || e;
                    return (
                        fe.test(t.type) && t.click && S(t, "input") && Se(t, "click"),
                        !0
                    );
                },
                _default: function (e) {
    ...
    function Oe(e, t) {
        return (
            (S(e, "table") &&
                S(t.nodeType !== 11 ? t : t.firstChild, "tr") &&
    ...
    function Re(n, r, i, o) {
        ...
        var e,
            ...
            p = r[0],
            h = x(p);
        if (h || (f > 1 && typeof p === "string" && !b.checkClone && je.test(p)))
    ...
    function Be(e, t, n) {
        for (var r, i = t ? E.filter(t, e) : e, o = 0; (r = i[o]) != null; o++)
            n || r.nodeType !== 1 || E.cleanData(ge(r)),
                r.parentNode &&
            ...
            if (
                ...
                for (a = ge(c), r = 0, i = (o = ge(e)).length; r < i; r++)
                    (s = o[r]),
                        (u = a[r]),
                        void 0,
                        (l = u.nodeName.toLowerCase()) === "input" && fe.test(s.type)
                            ? (u.checked = s.checked)
                            : (l !== "input" && l !== "textarea") ||
        ...
        E.fn.extend({
            ...
            empty: function () {
                for (var e, t = 0; (e = this[t]) != null; t++)
                    e.nodeType === 1 && (E.cleanData(ge(e, !1)), (e.textContent = ""));
                return this;
            },
            clone: function (e, t) {
                return (
    ...
    !(function () {
        ...
        u.style &&
            ...
            (b.clearCloneStyle = u.style.backgroundClip === "content-box"),
            E.extend(b, {
    ...
    function tt(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2)
            n === "margin" && (u += E.css(e, n + re[a], !0, i)),
                r
                    ? (n === "content" && (u -= E.css(e, "padding" + re[a], !0, i)),
                      n !== "margin" &&
    ...
    E.extend({
        ...
        E.each(["height", "width"], function (e, u) {
            E.cssHooks[u] = {
                ...
                set: function (e, t, n) {
                    var r,
                        i = We(e),
                        o = !b.scrollboxSize() && i.position === "absolute",
                        a = (o || n) && E.css(e, "boxSizing", !1, i) === "border-box",
                        s = n ? tt(e, u, n, a, i) : 0;
                    return (
                        a &&
                            o &&
        ...
        E.each({margin: "", padding: "", border: "Width"}, function (i, o) {
            (E.cssHooks[i + o] = {
                ...
                i !== "margin" && (E.cssHooks[i + o].set = et);
        }),
        E.fn.extend({
            css: function (e, t) {
                return z(
    ...
    E.fn.extend({
        ...
        E.extend({
            ...
            attrHooks: {
                type: {
                    set: function (e, t) {
                        if (!b.radioValue && t === "radio" && S(e, "input")) {
                            var n = e.value;
    ...
    function lt(e) {
        return Array.isArray(e) ? e : (typeof e === "string" && e.match(I)) || [];
    }
    E.fn.extend({
        prop: function (e, t) {
            ...
            toggleClass: function (i, t) {
                ...
                return typeof t === "boolean" && a
                    ...
                    : this.each(function () {
                          ...
                          } else (void 0 !== i && o !== "boolean") || ((e = ut(this)) && G.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === i ? "" : G.get(this, "__className__") || ""));
                      });
            },
            hasClass: function (e) {
                var t,
                ...
                t = " " + e + " ";
                while ((n = this[r++]))
                    if (n.nodeType === 1 && (" " + st(ut(n)) + " ").indexOf(t) > -1)
                        return !0;
                return !1;
            },
        });
            ...
            return arguments.length
                ? ((i = x(n)),
                  this.each(function (e) {
                      var t;
                      this.nodeType === 1 &&
                          ((t = i ? n.call(this, e, E(this).val()) : n) == null
                              ? (t = "")
                              : typeof t === "number"
                              ? (t = String(t))
                              : Array.isArray(t) &&
        ...
        trigger: function (e, t, n, r) {
            ...
            if (
                ...
                n.nodeType !== 3 &&
                    ...
                    ((e = e[E.expando]
                        ? e
                        : new E.Event(p, typeof e === "object" && e)).isTrigger = r
                        ? 2
                        : 3),
                    (e.namespace = h.join(".")),
                ...
                while ((o = d[i++]) && !e.isPropagationStopped())
                    (f = o),
                        (e.type = i > 1 ? s : c.bindType || p),
                        (l =
                            (G.get(o, "events") || {})[e.type] && G.get(o, "handle")) &&
                            l.apply(o, t),
                        (l = u && o[u]) &&
                            l.apply &&
                            Q(o) &&
    ...
    (E.param = function (e, t) {
        ...
        E.fn.extend({
            ...
            position: function () {
                if (this[0]) {
                    var e,
                        ...
                        r = this[0],
                        i = {top: 0, left: 0};
                    if (E.css(r, "position") === "fixed") t = r.getBoundingClientRect();
                    else {
                        (t = this.offset()),
                            (n = r.ownerDocument),
            ...
            offsetParent: function () {
                return this.map(function () {
                    ...
                    while (e && E.css(e, "position") === "static") e = e.offsetParent;
                    return e || ie;
                });
            },
        }),
            ...
            E.fn[t] = function (e) {
                return z(
                    ...
                    function (e, t, n) {
                        var r;
                        if (
                            (w(e) ? (r = e) : e.nodeType === 9 && (r = e.defaultView),
                            void 0 === n)
                        )
                            return r ? r[i] : e[t];
                        r
        ...
        (E.proxy = function (e, t) {
            var n, r, i;
            if ((typeof t === "string" && ((n = e[t]), (t = e), (e = n)), x(e)))
                return (
