...
class DeliveryShipmentScanDocumentLocationCase(DeliveryShipmentCommonCase):
    ...
    def setUpClassBaseData(cls, *args, **kwargs):
        ...
        cls._fill_stock_for_moves(cls.pick_subloc.move_ids[0], location=cls.sublocation)
        cls._fill_stock_for_moves(
            cls.pick_subloc.move_ids[1], in_package=True, location=cls.sublocation
        )
        cls._fill_stock_for_moves(
            cls.pick_subloc.move_ids[2], in_lot=True, location=cls.sublocation
        )
    ...
    def test_scan_document_package_after_location(self):
        ...
        """
        self._plan_records_in_shipment(self.shipment, self.pick_subloc.move_ids)
