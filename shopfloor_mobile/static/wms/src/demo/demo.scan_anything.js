...
var DEMO_SCAN_ANYTHING_PRODUCT = {
    data: {
        ...
        detail_info: {
            ...
            image:
                "http://localhost/web/image?model=product.template&id=16&field=image_128&unique=04022020111236",
            lot: "AA8122F41",
...
var DEMO_SCAN_ANYTHING_OPERATION = {
    data: {
        ...
        detail_info: {
            ...
            priority: 3,
            note:
                "Oh so this could be a really long text, how should it be implemented ?",
            moves: [
                {
                    id: 424,
                    name: "Sun Glasses Cat 4 High Altitude",
